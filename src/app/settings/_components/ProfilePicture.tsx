    ...
    <div className="w-full flex gap-3">
      ...
      <div className="flex items-center justify-center w-1/6">
        <label
          ...
          className="flex flex-col items-center justify-center w-full h-28 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:hover:border-gray-500"
        >
